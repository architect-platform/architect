...
object BuiltInArchitectureRulesets {
    private val rulesets = mapOf(
        ...
        "kotlin-conventions" to RuleSet(
            description = "Opinionated Kotlin defaults for structure, documentation, and test coverage.",
            rules = listOf(
                ArchitectureRule(
                    id = "kotlin-structure-required",
                    description = "Kotlin projects should use standard source directories",
                    type = "structure",
                    paths = listOf("src/main/kotlin", "src/test/kotlin", "README.md"),
                    severity = "warning",
                    suggestion = "Create the standard Kotlin source layout or override the preset in architect.yml.",
                ),
                ArchitectureRule(
                    id = "kotlin-tests-named-test",
                    description = "Kotlin tests should end with Test or Tests",
                    type = "naming",
                    pattern = ".*Test(s)?",
                    paths = listOf("src/test/.*\\.kt"),
                    severity = "warning",
                    suggestion = "Rename the test class or file to end with Test or Tests.",
                ),
                ArchitectureRule(
                    id = "kotlin-public-kdoc",
                    description = "Public Kotlin declarations should include KDoc",
                    type = "convention",
                    convention = "kdoc-required",
                    paths = listOf("src/main/.*\\.kt"),
                    severity = "warning",
                    suggestion = "Add KDoc above public Kotlin declarations.",
                ),
                ArchitectureRule(
                    id = "kotlin-production-tests",
                    description = "Production Kotlin declarations should have tests",
                    type = "convention",
                    convention = "test-class-exists",
                    paths = listOf("src/main/.*\\.kt"),
                    severity = "warning",
                    suggestion = "Add a matching test under src/test/kotlin.",
                ),
            ),
        ),
        "typescript-conventions" to RuleSet(
            description = "Opinionated TypeScript defaults for structure, docs, and tests.",
            rules = listOf(
                ArchitectureRule(
                    id = "typescript-structure-required",
                    description = "TypeScript projects should include source, tests, and config",
                    type = "structure",
                    paths = listOf("src", "package.json", "tsconfig.json"),
                    severity = "warning",
                    suggestion = "Create the standard TypeScript project files or override the preset in architect.yml.",
                ),
                ArchitectureRule(
                    id = "typescript-test-files",
                    description = "TypeScript test files should use .test or .spec naming",
                    type = "naming",
                    pattern = ".*(test|spec)",
                    paths = listOf("src/.*\\.(test|spec)\\.(ts|tsx)"),
                    severity = "warning",
                    suggestion = "Rename the file to include .test or .spec.",
                ),
                ArchitectureRule(
                    id = "typescript-public-tsdoc",
                    description = "Exported TypeScript declarations should include TSDoc",
                    type = "convention",
                    convention = "tsdoc-required",
                    paths = listOf("src/.*\\.(ts|tsx)"),
                    severity = "warning",
                    suggestion = "Add TSDoc comments above exported declarations.",
                ),
                ArchitectureRule(
                    id = "typescript-production-tests",
                    description = "Production TypeScript declarations should have tests",
                    type = "convention",
                    convention = "test-class-exists",
                    paths = listOf("src/.*\\.(ts|tsx)"),
                    severity = "warning",
                    suggestion = "Add a matching .test or .spec file under src.",
                ),
            ),
        ),
    )
