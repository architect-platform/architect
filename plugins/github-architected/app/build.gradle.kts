...
dependencies {
  ...
  implementation("com.fasterxml.jackson.core:jackson-databind:2.22.2") // core Jackson
  implementation("com.fasterxml.jackson.module:jackson-module-kotlin:2.22.2") // Kotlin support
