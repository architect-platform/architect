package io.github.architectplatform.cloud.architecture
...
class ArchitectureTest {
    ...
    fun `services should implement use cases`() {
        classes()
            ...
            .orShould().implement(io.github.architectplatform.cloud.application.ports.inbound.TrackExecutionEventUseCase::class.java)
            .check(classes)
    }
    ...
    fun `adapters should implement ports`() {
        classes()
            ...
            .should().implement(io.github.architectplatform.cloud.application.ports.outbound.EngineInstancePort::class.java)
            .orShould().implement(io.github.architectplatform.cloud.application.ports.outbound.ProjectPort::class.java)
            .orShould().implement(io.github.architectplatform.cloud.application.ports.outbound.ExecutionPort::class.java)
            .orShould().implement(io.github.architectplatform.cloud.application.ports.outbound.ExecutionEventPort::class.java)
            .check(classes)
    }
